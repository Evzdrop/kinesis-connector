...
import com.twitter.kinesis.utils.BasicAuthBase64Encoded;
import com.twitter.hbc.core.endpoint.EnterpriseStreamingEndpoint;
import com.twitter.hbc.core.endpoint.RealTimeEnterpriseStreamingEndpointV2;
...
public class ConnectorApplication {
  ...
  private Authentication auth() {
    return new BasicAuthBase64Encoded(this.environment.userName(), this.environment.userPassword());
  }
  ...
  private EnterpriseStreamingEndpoint endpoint() {
    ...
    return new RealTimeEnterpriseStreamingEndpointV2(account, product, label);
  }
}